...
(function(){
  ...
  const adminScrollManagerScript = document.createElement('script');

  adminScrollManagerScript.src = './admin-scroll-manager.js';

  document.head.appendChild(adminScrollManagerScript);
  ...
  document.addEventListener('DOMContentLoaded', function(){
    ...
    setTimeout(() => {
      ...
      if (typeof restoreAdminScrollPosition === 'function') {
    ...
    window.addEventListener('beforeunload', function() {
      ...
      if (typeof saveAdminScrollPosition === 'function') {
